...
\begin{abstract}
This document contains the procedure to solve system of linear equations using matrix method.
\end{abstract}

Download the python code from 
\begin{lstlisting}
https://github.com/ankuraditya13/Assignment2
\end{lstlisting}
%
...
\section{Problem}
Solve the system linear equations,using matrix
method.
\begin{align}
5x + 2y = 4 \\
7x + 3y = 5
